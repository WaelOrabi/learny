...
class SearchBarTeacherAppointmentsWidget extends StatefulWidget {
  const SearchBarTeacherAppointmentsWidget({Key? key}) : super(key: key);

  @override
  State<SearchBarTeacherAppointmentsWidget> createState() => _SearchBarTeacherAppointmentsWidgetState();
}

class _SearchBarTeacherAppointmentsWidgetState extends State<SearchBarTeacherAppointmentsWidget> {
  ...
  void _addEventToBloc(BuildContext context) {
   ...
   BlocProvider.of<GetTeacherAppointmentsBloc>(context).list=statuses;
    BlocProvider.of<GetTeacherAppointmentsBloc>(context)
        .add(GetTeacherAppointments(statuses: statuses, pageNumber:1));
  }
