...
import '../../../../teachers/presentation/widgets/request_details_widgets/display_video.dart';
import '../../../../teachers/presentation/widgets/show_details_teacher/display_video_youtube.dart';
...
class _PostVideoState extends State<PostVideo> {
  ...
  void initState() {
    ...
    BlocProvider.of<PostsBloc>(context).add(GetAllPostsEvent(
        pageId: "1", languageId: "1,2", typeId: "1", postLevelId: '1,2,3'));
    getUserInformation();
    super.initState();
  }
                      ...
                      SingleChildScrollView(
                        child: Column(
                          children: [
                            ...
                            Column(
                              children:
                                  List.generate(postEntity.length, (index) {
                                _controller ??= VideoPlayerController.network(
                                    postEntity[index].postName);
                                return Column(
                                  children: [
                                    Container(
                                      width: 900.w,
                            ...
                            if (pagesPage.currentPage == "0")
                              Padding(
                                  ...
                                  child: Center(
                                    child: Text(
                                      "There are not any Videos,try with other Filter",
                                      style: TextStyle(
